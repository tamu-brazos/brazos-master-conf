...
# Openstack
mod 'puppetlabs/glance', '3.0.0'
mod 'puppetlabs/horizon', '3.0.0'
mod 'puppetlabs/keystone', '3.0.0'
mod 'puppetlabs/ceilometer', '3.0.0'
mod 'puppetlabs/cinder', '3.0.0'
mod 'puppetlabs/swift', '>= 3.0.0 <4.0.0'
mod 'puppetlabs/nova', '3.0.0'
mod 'puppetlabs/neutron', '3.0.0'
...
mod 'nfs', :git => 'git://github.com/treydock/puppet-nfs.git', :ref => '0.0.1-RC1'
