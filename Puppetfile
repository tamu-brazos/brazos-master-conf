...
mod 'brazos', :git => 'git@github.tamu.edu:brazos/puppet-brazos.git', :ref => 'develop'
...
mod 'root', :git => 'git@github.tamu.edu:treydock/puppet-root.git'
mod 'site_selinux', :git => 'git://github.com/treydock/puppet-site_selinux.git'
mod 'site_slurm', :git => 'git@github.tamu.edu:brazos/puppet-module-site_slurm.git'
